...
def runtest(mapfile, start, goal, precision, epsilon, verbose = True):
  '''
  This function:
  ...
  MP = astar.Astar(boundary, blocks, start, goal, precision, epsilon, reopen_nodes = False)
  ...
  return success, pathlength, num_nodes
...
def test_single_cube(verbose = True):
  ...
  for p in pres:
    for e in ep:
      ...
      success, pathlength, expansions = runtest(file_path, start, goal, p, e, verbose=False)
      print('For precision: %r'%p)
      print('For epsilon: %r'%e)
      print('Success: %r'%success)
      print('Path length: %f'%pathlength)
      print('Number of nodes expanded: %f'%expansions)
      print('\n')
      '''
  success, pathlength, expansions = runtest(file_path, start, goal, precision, epsilon, verbose)
  print('Success: %r'%success)
  print('Path length: %f'%pathlength)
  print('Number of nodes expanded: %f'%expansions)
  print('\n')
...
def test_window(verbose = True):
  ...
  #success, pathlength = runtest(file_path, start, goal, verbose)
  #success, pathlength, expansions = runtest(file_path, start, goal, precision, verbose)
  success, pathlength, expansions = runtest(file_path, start, goal, precision, epsilon, verbose)
  print('Success: %r'%success)
  print('Path length: %f'%pathlength)
  print('Number of nodes expanded: %f'%expansions)
